        ...
        tracks.forEach { trackData ->
            try {
                ...
                if (existing == null) {
                    ...
                    val trackEntity = app.async.data.database.entity.TrackEntity(
        ...
        playlists.forEach { playlistData ->
            try {
                ...
                if (existing == null || mergeMode == ImportMergeMode.REPLACE) {
                    // Create new playlist
                    val playlistEntity = app.async.data.database.entity.PlaylistEntity(
    ...
    private suspend fun importPlayHistoryData(history: List<PlayHistoryExportData>): Int {
        ...
        history.forEach { historyData ->
            try {
                ...
                if (track != null) {
                    val historyEntity = app.async.data.database.entity.PlayHistoryEntity(
                        trackId = track.id,
