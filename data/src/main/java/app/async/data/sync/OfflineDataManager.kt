...
class OfflineDataManager(
     ...
     */
    suspend fun searchOffline(query: String, limit: Int = 50): List<app.async.data.database.entity.TrackEntity> {
        return try {
     ...
     */
    suspend fun getOfflineRecommendations(limit: Int = 20): List<app.async.data.database.entity.TrackEntity> {
        return try {
