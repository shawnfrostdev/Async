package app.async.core.extension

import app.async.core.model.Album
import app.async.core.model.Artist
import app.async.core.model.ExtensionResult
...
interface MusicExtension {
    ...
    suspend fun getArtist(artistId: String): ExtensionResult<Artist> {
        return ExtensionResult.Error(
            app.async.core.model.ExtensionException.GenericError("Artist lookup not supported by this extension")
        )
    }
    ...
    suspend fun getAlbum(albumId: String): ExtensionResult<Album> {
        return ExtensionResult.Error(
            app.async.core.model.ExtensionException.GenericError("Album lookup not supported by this extension")
        )
    }
    ...
    suspend fun getAlbumTracks(albumId: String): ExtensionResult<List<SearchResult>> {
        return ExtensionResult.Error(
            app.async.core.model.ExtensionException.GenericError("Album tracks not supported by this extension")
        )
    }
    ...
    suspend fun getArtistTracks(
        ...
        return ExtensionResult.Error(
            app.async.core.model.ExtensionException.GenericError("Artist tracks not supported by this extension")
        )
    }
